...
class LanceurTest
{
    ...
    /**
     * Rôle : Définir l'élément dont les tests vont être exécutés.
    ...
    /**
     * Rôle : Comparer une valeur obtenue avec la valeur attendue.
    ...
    /**
     * Rôle : Afficher les résultats de chaque élément testé
