 ...
 * Rôle : Vérifier que la classe Database communique correctement avec la base de données et que ses principales méthodes continuent de fonctionner après une modification du code.
 * Tâches :
