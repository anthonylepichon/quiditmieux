 ...
 *
 * Rôle : Vérifier que la session démarre correctement et conserve l'identifiant de l'utilisateur connecté afin de détecter une régression après une modification du code.
